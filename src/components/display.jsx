    ...
    return (
        ...
        <div>
            <div className="flex flex-wrap md:gap-6 justify-evenly md:justify-center p-1 md:p-4 w-fit mx-auto  font-[cursive] text-lg">
                ...
                <button value={"popular"} onClick={handleClick} className={`px-4 py-2 rounded-full cust-drop-shadow hover:cursor-pointer  hover:bg-gray-400/80  hover:text-gray-100  ${list === "popular"?" bg-purple-400/80  text-gray-100 hover:bg-purple-400/80 pointer-events-none":""}`}>Trending</button>
                <button value={"top_rated"} onClick={handleClick} className={`px-4 py-2 rounded-full cust-drop-shadow hover:cursor-pointer  hover:bg-gray-400/80  hover:text-gray-100  ${list === "top_rated"?" bg-purple-400/80  text-gray-100 hover:bg-purple-400/80 pointer-events-none":""}`}>Top Rated</button>
                <button value={"upcoming"} onClick={handleClick} className={`px-4 py-2 rounded-full cust-drop-shadow hover:cursor-pointer  hover:bg-gray-400/80  hover:text-gray-100  ${list === "upcoming"?" bg-purple-400/80  text-gray-100 hover:bg-purple-400/80 pointer-events-none":""}`}>Upcoming</button>
            </div>
